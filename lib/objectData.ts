...
export const OBJECTS: Record<ObjectId, ObjectData> = {
  monitor: {
    ...
    content: {
      ...
      items: [
        { label: '🟢 Arjun Singh', value: 'Cybersecurity Engineer — Black tactical suit. Penetration testing, zero-trust architecture, secure DevOps.' },
        { label: '🔵 Tanmay Dev', value: 'Full Stack Developer — MERN stack specialist. React, Node.js, WebSockets, REST APIs, production deployments.' },
        { label: '🟣 Priya Nair', value: 'ML Engineer — Neural networks, NLP pipelines, model deployment, LLM fine-tuning.' },
      ],
    },
  },
  coffee: {
